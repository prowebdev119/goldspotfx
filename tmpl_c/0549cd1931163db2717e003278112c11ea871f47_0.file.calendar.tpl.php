<?php /* Smarty version 3.1.27, created on 2022-08-10 13:29:09
         compiled from "/home/goldainy/public_html/tmpl/calendar.tpl" */ ?>
<?php
/*%%SmartyHeaderCode:29003744162f3eae59458e8_93352356%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0549cd1931163db2717e003278112c11ea871f47' => 
    array (
      0 => '/home/goldainy/public_html/tmpl/calendar.tpl',
      1 => 1660045178,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '29003744162f3eae59458e8_93352356',
  'variables' => 
  array (
    'plans' => 0,
    'currency_pow' => 0,
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_62f3eae5999ff0_10368531',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_62f3eae5999ff0_10368531')) {
function content_62f3eae5999ff0_10368531 ($_smarty_tpl) {
...
$_smarty_tpl->properties['nocache_hash'] = '29003744162f3eae59458e8_93352356';
?>
<html>
<head>
...
<?php endfor; endif; ?>
var currencyPow = <?php echo smarty_modifier_myescape($_smarty_tpl->tpl_vars['currency_pow']->value);?>
;

paymentperiod = '<?php echo smarty_modifier_myescape($_smarty_tpl->tpl_vars['type']->value['period']);?>
'; // 'd' - daily, 'w' - weekly, 'bw' - beweekly, 'm' - monthly, 'y' - yearly
var maxdays = <?php echo smarty_modifier_myescape($_smarty_tpl->tpl_vars['type']->value['q_days']+$_smarty_tpl->tpl_vars['type']->value['delay']);?>
;
...
;
var compound = <?php echo smarty_modifier_myescape($_smarty_tpl->tpl_vars['type']->value['use_compound']);?>
;
var delay = <?php echo smarty_modifier_myescape($_smarty_tpl->tpl_vars['type']->value['delay']);?>
;
...
<tr>
  ...
  <td align=center>
   <select name="monthes" onchange="InitCalendar(document.data.monthes.value, document.data.years.value)" class=inpts>
   ...
   <select name="years" onchange="InitCalendar(document.data.monthes.value, document.data.years.value)" class=inpts>
   </select>
  </td>
...
<table>
<tr>
  <td>From:</td><td><b><?php echo '<script'; ?>
>document.write(CurDate.getMonth()+1 + '/' + CurDate.getDate() + '/' + CurDate.getFullYear())<?php echo '</script'; ?>
></b></td>
</tr>
<tr>
...
<tr>
  <td><?php echo smarty_modifier_myescape($_smarty_tpl->tpl_vars['type']->value['period_name']);?>
:</td><td><b><span id="days">N/A</span></b></td>
</tr>
</tr>
  <td>Amount:</td><td nowrap><?php echo smarty_modifier_myescape($_smarty_tpl->tpl_vars['currency_sign']->value);?>
 <input type="text" name="amount" value="<?php echo smarty_modifier_myescape(number_format($_smarty_tpl->tpl_vars['type']->value['min_deposit'],2,".",''));?>
" size=5 class=inpts> <input type="button" value="Calculate" onclick="CalculateProfit()" class=sbmt></td>
</tr>
<?php if ($_smarty_tpl->tpl_vars['type']->value['use_compound']) {?>
<tr>
...
<tr>
  <td nowrap>Deposit <?php echo smarty_modifier_myescape($_smarty_tpl->tpl_vars['currency_sign']->value);?>
:</td><td><b><span id="deposit">N/A</span></b></td>
</tr>
